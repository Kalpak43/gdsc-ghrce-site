...
export default function CoreConfluenceVolunteer () {
    ...
    const getData = async () => {
      const { data } = await axios.get(
        `https://script.google.com/macros/s/AKfycbxmFo17Yq5qMo__Ph1B3PpI52C6v9b9DMa8M3ajre2sduVZSpP6wL3qZYq5DVZykU1sbA/exec?Reference=${refID}`
      );
